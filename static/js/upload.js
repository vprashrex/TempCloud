...
function addFileToQueue(file){
	if (file.size > 1024 * 1024 * 1024 * 10 && location.hostname != "192.168.0.104" && location.hostname != "10.6.0.1"){ //fancy thing to bypass 10GiB limit for an admin, if removed, the server will not allow the upload anyway
...
function codeRowClicked(){
	...
	textarea.value = `http://localhost:8000/api/?c=${this.children[1].textContent}`;
